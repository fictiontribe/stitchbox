...
function FictionTribeLogo({ className = "h-3.5 w-auto" }) {
  return (
    <svg className={className} viewBox="0 0 227 28" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Fiction Tribe">
